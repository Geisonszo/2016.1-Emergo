...
public class SearchHealthUnitActivityUITest extends ActivityInstrumentationTestCase2<SearchHealthUnitActivity> {

  public SearchHealthUnitActivityUITest() {

    super(SearchHealthUnitActivity.class);
  }
